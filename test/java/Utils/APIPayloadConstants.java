...
public class APIPayloadConstants {
    ...
    public static String createEmployeePayloadJson() {
        ...
        obj.put("emp_firstname", "Urwa");
        obj.put("emp_lastname", "Waseem");
        obj.put("emp_middle_name", "Ms");
        obj.put("emp_gender", "F");
        obj.put("emp_birthday", "1998-10-13");
    ...
    public static String updateEmployeePayloadJson() {
        JSONObject obj = new JSONObject();
        obj.put("employee_id", "57584A");
        obj.put("emp_firstname", "Alyna");
        obj.put("emp_lastname", "Hussnain");
        obj.put("emp_middle_name", "mehar");
        obj.put("emp_gender", "F");
        obj.put("emp_birthday", "21-10-2022");
